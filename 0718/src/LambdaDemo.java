/*
    Lambda & Stream API
    1. Lambda Expression
     1) 객체 지향 언어에서 사용하지 않고, Scala나 Groovy 같은 함수형 언어에서 사용하던 문법
     2) 메소드는 클래스 안에서 객체의 행위를 정의하지만, Expression이라고 쓴 이유는
     ...
     4) 순서
        ...
        - 파라미터 타입을 삭제한다.
            -- 굳이 파라미터 타입을 정의하도 추론이 가능하다면 파라미터 타입 삭제 가능하고,
               추론이 불가능하면 파라미터 타입을 명시하는데, 모두 명시해야 한다.
        - 메소드의 바이의 return을 삭제한다.
        - 메소드 () 뒤의 {}를 삭제한다.
            -- 메소드 구현부의 문장이 한 개일 경우에만 삭제한다.
        - 메소드의 파라미터 선언부 괄호 뒤와 {} 사이였던 부분을 "->" 화살표연산자로 연결한다.
 */
public class LambdaDemo {
    public static void main(String[] args) {
        int c = 5, d = 10;
        // Child child = new Child();
        // int result = child.add(c, d);
